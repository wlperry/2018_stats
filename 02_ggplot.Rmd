...
Now click - ```File - New Project``` and create a project in the 2018_stats folder. This is what you will open to start working on the project and then you can work with scripts in there.
...
[iris_excel.xlsx](https://wlperry.github.io/2017stats/data/iris_excel.xlsx)    
