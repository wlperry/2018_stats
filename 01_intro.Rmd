...
###Comment your code     
You should use comments `#` with text behind it to annotate the purpose of what your are doing and what is happeing in the code chunk below.

##Installing R
So lets start installing R and R studio    
R is its own program and can be retreived from [R Cran](https://cran.r-project.org/)   
<br>   
R Studio is a program that makes the interface and usability of R easier in my opinion and can be retreived here [R Studio](https://www.rstudio.com/products/rstudio/download/)    

<br>
When you get these intalled we can load up R studio and look at the interface.   

###R interface 
Start R stduio and you should see:
...
![Project set up](images/setup_2.png)
   ...
   You can select `New Directory` or you can select existing directory - lets say you choos new directory
   ![File New Project New Directory](images/setup_3.png)   
   
 For now you are doign a `New Project `.  We will talk about Github at a later date    
