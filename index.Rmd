...
## [Basics of projects](000_intro.html)     
...
## [Packages/Loading Libraries](001_basics_and_install_packages.html)         
This page contains many of the packages I use with the installation codes and how to load the libraries.      
     
## [1. Reading files and plotting](01_reading_in_data_and_graphing.html)      
The intial steps to using tidyverse is to use readr to load the dataframes. Then the next step is to begin graphing the data. This page does over most of the basics of plotting.   

## [2. Advanced Plotting](02_Finalized_Plotting.html)       
This page goes over some of the more advanced plotting command and tricks for GGPlot. This should allow you to make graphs formatted for publication.     
   
## [2.5 Plot layout and Patchworkd](02_5_Patchwork_plotting.html)     
This page covers how to do advanced plotting with different using the awesome package Patchwork.     
...
## [4. Data mutate/summary](04_Modifying_variables_mutating_summarizing.html)         
...
## [6. Datetimes with lubridate](06_Modifying_variables_datetimes.html)    
Working with dates is never fun unless you use Lubridate.         

## [7. Long/wide dataframes](07_Modifying_dataframe_structure_long_wid.html)  
...
## [21.  rLakeAnalyzer preparation](21_Lake_analyzer_data_prep.html)  
...
## [24. Heat plots for lake temp](24_lake_heatmaps.html)  
...
## [31. Correlation](31_correlation.html)  
Correlations      

## [32. Regressions](32_regression.html)  
Regression     

## [33. Ttests](33_ttests.html)  
Ttests

## [34. One way AOV](34_oneway_anova.html)  
One way Anovas

## [35. Two way AOV with post F tests](35_twoway_anova.html)  
Two way Anovas
