...
### ata structure and format
R uses a column format and all the data in a column has to be of the same type. You can, however, refernece data by row and column as in excel.      
<br>
...
* individual         
* species        
* trait all in one colunm (petal length, petal width, sepal length , sepal width)          
* value (the values of each of the resprective traits)          
