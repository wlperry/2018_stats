...
##Statistical plots     
So now lets try to do a few plots that are useful for publication. the first will be a mean and standard error plot and we will try this with mutliple data in wide format
